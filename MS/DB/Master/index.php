...
$lang = array(
	...
	"powered" => "Developed & Maintained by",
	"free_software" => "This software is only for Million Solutions LLP Internal use Only.",
	"please_donate" => "mail us on : dev@millionsllp.com.",
...
define('PROJECT_URL','https://www.millionsllp.com/');
define('DONATE_URL','https://www.millionsllp.com/');
define('VERSION_CHECK_URL','https://www.millionsllp.com/');
...
<title><?php echo PROJECT ?> : <?php echo VERSION ?></title>
...
if(!$auth->isAuthorized())
{
	...
	echo "<h1><span id='logo'> <img src='/img/logo-color hd.png' style='max-height: 60px'> </span><br /> <span id='version'>v".VERSION."</span></h1>";
...
echo "<span id='logo'><img src='/img/logo-color hd.png' style='max-height: 30px'></span><br /> <span id='version'>v".VERSION."</span>";
echo "</a></h1>";
...
//- HTML: page footer
echo "<br/>";
echo "<span style='font-size:11px;'>".$lang['powered']." <a href='https://www.millionsllp.com' target='_blank' style='font-size:11px;'> <img src='/img/logo_final.png' style='max-height: 26px;margin-bottom: -8px;'></a> | ";

echo $lang['free_software']." <a href='mailto:dev@millionsllp.com' target='_blank' style='font-size:11px;'>".$lang['please_donate']."</a> | ";
